...
#. Click a bucket in the **OBS Bucket** column.
   ...
   .. figure:: /_static/images/en-us_image_0000002344705712.png
...
#. Decompress the downloaded package to obtain a JSON file with the same name as the package, as shown in :ref:`Figure 2 <cts_02_0006__en-us_topic_0000001285318397_fig165592091189>`. Open the JSON file using a text file editor to view traces.

   .. _cts_02_0006__en-us_topic_0000001285318397_fig165592091189:

   .. figure:: /_static/images/en-us_image_0000002378503733.png
      :alt: **Figure 2** JSON file

      **Figure 2** JSON file

.. |image1| image:: /_static/images/en-us_image_0000002344545908.png
